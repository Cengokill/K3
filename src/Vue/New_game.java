...
public class New_game extends javax.swing.JFrame {
    ...
    private void bp_STARTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bp_STARTActionPerformed
        ...
        if(this.jRadioButton2.isSelected() || this.jRadioButton3.isSelected()) {
            visuel.setpartie(partie);
            if(this.jRadioButton3.isSelected()) {
                visuel.j1 = this.jTextField3.getText();
                visuel.j2 = "IA ";
                visuel.vsIA = true;
            }
            else {
            ...
            visuel.setpartie(partie);
            visuel.j1 = this.jTextField2.getText();
            visuel.j2 = this.jTextField3.getText();
        }
