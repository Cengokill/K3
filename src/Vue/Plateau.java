...
public class Plateau extends javax.swing.JFrame {
    // public final String
    // chemin="C:\\Users\\farid\\Documents\\NetBeansProjects\\K3\\src\\main\\java\\ressources\\";
    public final String CHEMIN = "C:\\Users\\Killian\\Desktop\\D�veloppement Eclipse\\Espace de travail\\K3\\src\\ressources\\";
    ...
    public void paint(Graphics g) {
        ...
        try {
            ...
            for (int i = 0; i < 4; i++) { // colone
                switch (i) {
                    case 2:
                        g.drawImage(image3, 4 / 3 * (test3.x + (i * uniteX4 * 2)), test4.y + (uniteY4 * 5), uniteX4,
                                uniteY4, null);
                        break;
                    case 3:
                    case 7:
                        g.drawImage(image2, 4 / 3 * (test3.x + (i * uniteX4 * 2)), test4.y + (uniteY4 * 5), uniteX4,
                                uniteY4, null);
                        break;
                    case 9:
                    case 1:
                    case 4:
                        g.drawImage(image4, 4 / 3 * (test3.x + (i * uniteX4 * 2)), test4.y + (uniteY4 * 5), uniteX4,
                                uniteY4, null);
                        break;
                    default:
                        g.drawImage(image, 4 / 3 * (test3.x + (i * uniteX4 * 2)), test4.y + (uniteY4 * 5), uniteX4,
                                uniteY4, null);
                        break;
                }
            }
        ...
        if (typejoueur == 1) {
            ...
            for (int i = 0; i < this.partie_actuel.joueur1().getCamp().getHauteur(); i++) { // colonne
                for (int j = 0; j < (this.partie_actuel.joueur1().getCamp().getlargeur() - i); j++) { // ligne
                    actualpos.x = j;
                    actualpos.y = i;
                    BufferedImage image = colortoimage(
                            this.partie_actuel.joueur1().getCamp().getPiece(actualpos).getColor());
                    switch (i) {
                        case 0:
                            switch (j) {
                                case 0:
                                    g.drawImage(image, (test.x + (0 * uniteX)), test.y + (5 * uniteY), uniteX, uniteY,
                                            null);
                                    break;
                                case 1:
                                    g.drawImage(image, (test.x + (1 * uniteX)), test.y + (5 * uniteY), uniteX, uniteY,
                                            null);
                                    break;
                                case 2:
                                    g.drawImage(image, (test.x + (2 * uniteX)), test.y + (5 * uniteY), uniteX, uniteY,
                                            null);
                                    break;
                                case 3:
                                    g.drawImage(image, (test.x + (3 * uniteX)), test.y + (5 * uniteY), uniteX, uniteY,
                                            null);
                                    break;
                                case 4:
                                    g.drawImage(image, (test.x + (4 * uniteX)), test.y + (5 * uniteY), uniteX, uniteY,
                                            null);
                                    break;
                                case 5:
                                    g.drawImage(image, (test.x + (5 * uniteX)), test.y + (5 * uniteY), uniteX, uniteY,
                                            null);
                                    break;
                            }
                            break;
                        ...
                        case 1:
                            switch (j) {
                                case 0:
                                    g.drawImage(image, test.x + (0 * uniteX) + (uniteX / 2), test.y + (4 * uniteY),
                                            uniteX, uniteY, null);
                                    break;
                                case 1:
                                    g.drawImage(image, (test.x + (1 * uniteX)) + (uniteX / 2), test.y + (4 * uniteY),
                                            uniteX, uniteY, null);
                                    break;
                                case 2:
                                    g.drawImage(image, (test.x + (2 * uniteX)) + (uniteX / 2), test.y + (4 * uniteY),
                                            uniteX, uniteY, null);
                                    break;
                                case 3:
                                    g.drawImage(image, (test.x + (3 * uniteX)) + (uniteX / 2), test.y + (4 * uniteY),
                                            uniteX, uniteY, null);
                                    break;
                                case 4:
                                    g.drawImage(image, (test.x + (4 * uniteX)) + (uniteX / 2), test.y + (4 * uniteY),
                                            uniteX, uniteY, null);
                                    break;
                            }
                            break;
                        case 2:
                            switch (j) {
                                case 0:
                                    g.drawImage(image, (test.x + (1 * uniteX)), test.y + (3 * uniteY), uniteX, uniteY,
                                            null);
                                    break;
                                case 1:
                                    g.drawImage(image, (test.x + (2 * uniteX)), test.y + (3 * uniteY), uniteX, uniteY,
                                            null);
                                    break;
                                case 2:
                                    g.drawImage(image, (test.x + (3 * uniteX)), test.y + (3 * uniteY), uniteX, uniteY,
                                            null);
                                    break;
                                case 3:
                                    g.drawImage(image, (test.x + (4 * uniteX)), test.y + (3 * uniteY), uniteX, uniteY,
                                            null);
                                    break;
                            }
                            break;
                        case 3:
                            switch (j) {
                                case 0:
                                    g.drawImage(image, (test.x + (2 * uniteX)) - (uniteX) + (uniteX / 2),
                                            test.y + (2 * uniteY), uniteX, uniteY, null);
                                    break;
                                case 1:
                                    g.drawImage(image, (test.x + (3 * uniteX)) - (uniteX) + (uniteX / 2),
                                            test.y + (2 * uniteY), uniteX, uniteY, null);
                                    break;
                                case 2:
                                    g.drawImage(image, (test.x + (4 * uniteX)) - (uniteX) + (uniteX / 2),
                                            test.y + (2 * uniteY), uniteX, uniteY, null);
                                    break;
                            }
                            break;
                        case 4:
                            switch (j) {
                                case 0:
                                    g.drawImage(image, (test.x + (2 * uniteX)), test.y + (1 * uniteY), uniteX, uniteY,
                                            null);
                                    break;
                                case 1:
                                    g.drawImage(image, (test.x + (i * uniteX)) - (uniteX), test.y + (j * uniteY),
                                            uniteX, uniteY, null);
                                    break;
                            }
                            break;
                        case 5:
                            switch (j) {
                                case 0:
                                    g.drawImage(image, (test.x + (2 * uniteX)) + (uniteX / 2), test.y + (0 * uniteY),
                                            uniteX, uniteY, null);
                                    break;
                            }
                            break;
            ...
            for (int i = 0; i < this.partie_actuel.joueur2().getCamp().getHauteur(); i++) { // colonne
                for (int j = 0; j < (this.partie_actuel.joueur2().getCamp().getlargeur() - i); j++) { // ligne
                    ...
                    actualpos.y = i;
                    BufferedImage image = colortoimage(
                            this.partie_actuel.joueur2().getCamp().getPiece(actualpos).getColor());
                    switch (i) {
                        case 0:
                            switch (j) {
                                case 0:
