...
public class ToolsPhase2 {

  public Jeu partie_actuel;
  ToolsImage galerie;

  public ToolsPhase2(Jeu partie) {
  ...
  public BufferedImage colortoimage(Couleurs c) {
    ...
    public void drawpyramide2(SuivieEtat etat ,Graphics g, int uniteX, int uniteY,javax.swing.JPanel jpanel, int typejoueur) {
        switch (typejoueur) {
    case 1: {
